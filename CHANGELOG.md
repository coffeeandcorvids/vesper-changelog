...
- [[2026-W35]] — Aug 25–31 (HAOS fresh install on Pi 5, The House HA dashboard V3 design, CCP diegetic dashboard build, LocalVes two-env-file footgun fix, NVMe SSD purchased for X3, CCP-to-Dungeon integration planned, Flash-Next verified superior, message delivery gap identified, agent JSON schema clarified, confabulation patterns caught and reinforced)
- [[2026-W34]] — Aug 18–24 (llama.cpp v0.1.0 fleet upgrade, X3 amdgpu crash recovery + kernel leak detection architecture, post-reboot recovery fixes, migration fossil resolution, system tools installed, remote keyring unlock + status board, Discord presence daemon, quantized KV cache loop bug, circuit breaker spec, reasoning_effort translation bug + mux capability-based fix + verified injection results, MoE GPU offload failure + SSM/Vulkan incompatibility, KV cache prefix invalidation, DFlash2 rejection, round-trip reduction analysis)
...
## Current Week — W34 (Aug 18–24, 2026)

Current entries live in [[2026-W34]].
